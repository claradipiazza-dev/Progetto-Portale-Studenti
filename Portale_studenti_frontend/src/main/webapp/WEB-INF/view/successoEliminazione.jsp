...
<head>
<meta charset="UTF-8">
<title> Successo Eliminazione </title>
            ...
            <div class="col-md-6">
                <div class="card text-center shadow">
                    <div class="card-header bg-success text-white">
                        <h4><i class="fas fa-check-circle"></i> Eliminazione Confermata!</h4>
                    </div>
                    <div class="card-body">
                        <p class="card-text">Hai eliminato correttamente la tua iscrizione al corso di laurea.</p>
