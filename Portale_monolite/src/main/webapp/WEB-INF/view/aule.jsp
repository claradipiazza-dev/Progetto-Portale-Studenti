...
<c:if test="${not empty iscrizioni.lista}">
<div class="container">
...
<br>
		...
		<div class="text-center mt-4">
			<form action="EliminaIscrizione" method="post">
				<input type="hidden" name="ins_id" value="${iscrizioni.lista[0].insegnamentoId}">
...
<c:if test="${empty iscrizioni.lista}">
